...
<CodesandboxDisplay
  codesandboxLink={"https://codesandbox.io/s/phresh-frontend-part-4-protecting-client-side-routes-8h0ep?file=/src/redux/auth.js"}
  codesandboxProps={{
...
<CodesandboxDisplay
  codesandboxLink={"https://codesandbox.io/s/phresh-frontend-part-4-registering-new-users-33wlt?file=/src/components/RegistrationForm/RegistrationForm.js"}
  codesandboxProps={{
...
<CodesandboxDisplay
  codesandboxLink={"https://codesandbox.io/s/phresh-frontend-part-4-handling-registration-errors-hb0fe?file=/src/components/RegistrationForm/RegistrationForm.js"}
  codesandboxProps={{
...
<CodesandboxDisplay
  codesandboxLink={"https://codesandbox.io/s/phresh-frontend-part-4-profile-page-jfct3?file=/src/components/Navbar/Navbar.js"}
  codesandboxProps={{
