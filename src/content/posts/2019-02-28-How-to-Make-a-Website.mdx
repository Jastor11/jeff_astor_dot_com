...
import anatomyOfHTML from "../../assets/posts/anatomy-of-an-html-element.png"
import attributeSyntax from "../../assets/posts/attribute-syntax.png"
import cssLabels from "../../assets/posts/css-labels.png"
...
<Image src={anatomyOfHTML} alt="Anatomy of an HTML element" className="bg-white p-1" />
...
<div>
  <p>
    This content is inside of the child tag, which is inside of the parent tag. Keep an eye on indentation to see which
...
<Image src={attributeSyntax} alt="html attributes syntax" className="bg-white p-1" />
...
<Image src={cssLabels} alt="css selector property and value syntax" className="bg-white p-1" />
