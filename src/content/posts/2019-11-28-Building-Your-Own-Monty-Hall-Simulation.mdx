...
import MontyHall from "@/components/MDX/viz/MontyHall"

import montyOpenDoor from "../../assets/posts/440px-Monty_open_door.png"
import montyTreeDoor from "../../assets/posts/Monty_tree_door1.png"
...
<Image src={montyOpenDoor} className="bg-white p-1" alt="monty hall door" />
...
<Image src={montyTreeDoor} className="bg-white p-1" alt="monty hall answer" />
