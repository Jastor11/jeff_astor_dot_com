...
> NOTE: This post was originally created as a lesson for my high school students. The target audience is math students who want to learn intro to stats.
...
<blockquote>
  {" "}
  Whenever we’re unsure about the outcome of an event, we can talk about the probabilities of certain outcomes—how likely
  they are. The analysis of events governed by probability is called statistics. - Khan Academy{" "}
</blockquote>

Khan Academy puts it nicely when they say:

<blockquote> Probability of an event = (# of ways it can happen) / (total number of outcomes)</blockquote>
...
<figure>
  ...
  <figcaption>
    Taken from this slideplayer <a href="https://slideplayer.com/slide/10865356/">deck</a>.
  </figcaption>
</figure>
...
If all the singular events in the event space (here denoted by $𝑆$) are equally as likely, then:
 ...
 <blockquote>  $𝑃(𝐸) = \frac{\#𝐸}{\#𝑆}$. </blockquote>
</blockquote>
...
<blockquote>𝑃(each outcome) = 1 / ∣𝑆∣</blockquote>
...
<blockquote>P(A) = (# of ways A can happen) / (Total number of outcomes)</blockquote>
...
<figure>
  <img
    style="border: none; min-width: 350px"
    src="https://www.mathsisfun.com/data/images/probability-marbles-tree1.gif"
  />
</figure>
