...
<CodesandboxDisplay
  codesandboxLink={
    "https://codesandbox.io/s/phresh-frontend-part-5-creating-cleaning-jobs-vkupu?file=/src/components/CleaningJobCreateForm/CleaningJobCreateForm.js"
  }
  codesandboxProps={{
...
<CodesandboxDisplay
  codesandboxLink={
    "https://codesandbox.io/s/phresh-frontend-part-5-the-cleanings-redux-slice-xomd9?file=/src/redux/rootReducer.js"
  }
  codesandboxProps={{
...
```python:title=<span>repositories/users.py</span>
# ...other code
...
<CodesandboxDisplay
  codesandboxLink={
    "https://codesandbox.io/s/phresh-frontend-part-5-fetching-cleaning-jobs-by-id-z4xd4?file=/src/components/CleaningJobView/CleaningJobView.js"
  }
  codesandboxProps={{
...
- https://github.com/Jastor11/phresh-tutorial/tree/part-17-consuming-a-fastapi-backend-from-a-react-frontend
