...
import codeAcademy from "../../assets/posts/codecademy-home.png"
import freeCodeCamp from "../../assets/posts/FreeCodeCamp_logo.png"
import forgettingCurve from "../../assets/posts/400px-ForgettingCurve.png"
...
<Image src={codeAcademy} alt="codecademy landing page" figCaption="The Codecademy landing page." className="bg-white p-1" />
...
<Image src={freeCodeCamp} alt="FreeCodeCamp logo" className="bg-white p-1" />
...
<iframe
  src="https://docs.google.com/forms/d/e/1FAIpQLSdRFQb_0yQdZiZKSP3kBrqvRhuWWiQX9AfluSf6YN5YrsdBCg/viewform?embedded=true"
  width="640"
  height="1000"
  frameborder="0"
  marginheight="0"
...
Then, in the first cell of the _2ND COLUMN_ of each sheet, paste in a formula that queries the submission sheet for only lessons related to that platform. Here's an example of what would go in my FreeCodeCamp Sheet.
...
In the _1ST COLUMN_ create a row for 'Calculated ID' and insert this formula:
...
<iframe
  src="https://docs.google.com/spreadsheets/d/e/2PACX-1vSXFY_64iVTKJjd5kGYurZmpnlaGIJpOuqrQvpFJPRs0u0jq7ySIqpIL6ItiAVNyPFAjM53me2aRwQl/pubhtml?widget=true&amp;headers=false"
  width="960"
  height="569"
...
<Image
  ...
  className="bg-white p-1 [&>img]:p-4 [&>figcaption]:max-w-[70%] [&>figcaption]:mx-auto"
  figCaption="The forgetting curve. Students forget almost 50% of what they've learned within 20 minutes and almost 75% within 3 days."
/>
...
<iframe
  src="https://docs.google.com/presentation/d/e/2PACX-1vRi4bWUNqcWlWZKHJZlbaVenNSRARvjvog4aASGvWTI8LUOgIxY-qwufYop4owhPFlfN0HasRf8q4jx/embed?start=false&loop=false&delayms=3000"
  frameborder="0"
  width="960"
  height="569"
  allowfullscreen="true"
