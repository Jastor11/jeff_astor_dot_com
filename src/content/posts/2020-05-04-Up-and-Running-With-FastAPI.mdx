...
published: "true"
slug: "up-and-running-with-fastapi-and-docker"
...
If you do want more info, the majority of this docker setup is derived from Michael Herman's excellent TestDriven.io [tutorial](https://testdriven.io/blog/fastapi-crud/). A link to his full course on FastAPI can be found at the bottom of this post.
...
- TestDriven.io [course](https://testdriven.io/courses/tdd-fastapi/intro/) - Test-Driven Development with FastAPI and Docker
