...
async def list_offers_for_cleaning() -> List[OfferPublic]:
    return None
...
async def cancel_offer(
    ...
    return await offers_repo.cancel_offer(
        offer=offer, 
        offer_update=OfferUpdate(status="cancelled"),
    )
...
- https://github.com/Jastor11/phresh-tutorial/tree/part-11-marketplace-functionality-in-fastapi
