...
router.include_router(  # highlight-line
    evaluations_router,  # highlight-line
    prefix="/users/{username}/evaluations",  # highlight-line
    tags=["evaluations"]  # highlight-line
)  # highlight-line
...
class TestGetEvaluations:
    ...
    async def test_authenticated_user_can_get_aggregate_stats_for_cleaner(
        ...
        assert mean([
            ...
            if e.professionalism is not None
...
- https://github.com/Jastor11/phresh-tutorial/tree/part-12-evaluations-and-sql-aggreations-in-fastapi
