...
<CodesandboxDisplay
  codesandboxLink={
    "https://codesandbox.io/s/phresh-frontend-part-1-elastic-ui-landing-page-carousel-with-framer-motion-f1vor"
  }
  codesandboxProps={{
...
<CodesandboxDisplay
  codesandboxLink={
    "https://codesandbox.io/s/phresh-frontend-part-1-elastic-ui-landing-page-carousel-title-with-framer-motion-py7oq"
  }
  codesandboxProps={{
